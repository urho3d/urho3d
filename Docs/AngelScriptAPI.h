...
void ApplyAttributes();
void BringToFront();
UIElement CreateChild(const String&, const String& = String ( ), uint = Limis<unsigned>::Max);
...
void SetParent(UIElement, uint = Limis<unsigned>::Max);
...
{
// Methods:
void AddChild(Node, uint = Limis<unsigned>::Max);
void AddTag(const String&);
void AddTags(const String&, int8 = ';');
void ApplyAttributes();
...
bool LoadXML(const XMLElement&, bool = false);
void MarkNetworkUpdate() const;
Array<RayQueryResult> Raycast(const Ray&, RayQueryLevel = RAY_TRIANGLE, float = Limis<float>::Infinity, uint8 = DRAWABLE_ANY, uint = DEFAULT_VIEWMASK) const;
RayQueryResult RaycastSingle(const Ray&, RayQueryLevel = RAY_TRIANGLE, float = Limis<float>::Infinity, uint8 = DRAWABLE_ANY, uint = DEFAULT_VIEWMASK) const;
void Remove();
void RemoveAttributeAnimation(const String&);
void RemoveInstanceDefault();
...
bool AddPackageFile(PackageFile, uint = Limis<unsigned>::Max);
bool AddPackageFile(const String&, uint = Limis<unsigned>::Max);
bool AddResourceDir(const String&, uint = Limis<unsigned>::Max);
...
{
// Methods:
void AddControlPoint(Node, uint = Limis<unsigned>::Max);
void ApplyAttributes();
...
void SetParent(UIElement, uint = Limis<unsigned>::Max);
void SetPosition(int, int);
void SetSelection(uint, uint = Limis<unsigned>::Max);
void SetSize(int, int);
bool SetStyle(const String&, XMLFile = null);
bool SetStyle(const XMLElement&);
bool SetStyleAuto(XMLFile = null);
...
float M_DEGTORAD;
float M_DEGTORAD_2;
float Limis<float>::Epsilon;
float M_HALF_PI;
float Limis<float>::Infinity;
float M_LARGE_EPSILON;
float M_LARGE_VALUE;
int Limis<signed>::Max;
uint Limis<unsigned>::Max;
int Limis<signed>::Min;
uint M_MIN_UNSIGNED;
float M_PI;
float M_RADTODEG;
float PIXEL_SIZE;
