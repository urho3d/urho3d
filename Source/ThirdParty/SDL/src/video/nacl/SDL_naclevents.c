            ...
            case PSE_INSTANCE_HANDLEINPUT:
                ...
                switch(type) {
                    ...
                    case PP_INPUTEVENT_TYPE_KEYDOWN:
                        SDL_SendKeyboardKey(SDL_PRESSED, (Uint32)(driverdata->ppb_keyboard_input_event->GetKeyCode(event)),
                                            SDL_NACL_translate_keycode(driverdata->ppb_keyboard_input_event->GetKeyCode(event)));
                        break;

                    case PP_INPUTEVENT_TYPE_KEYUP:
                        SDL_SendKeyboardKey(SDL_RELEASED, (Uint32)(driverdata->ppb_keyboard_input_event->GetKeyCode(event)),
                                            SDL_NACL_translate_keycode(driverdata->ppb_keyboard_input_event->GetKeyCode(event)));
                        break;
