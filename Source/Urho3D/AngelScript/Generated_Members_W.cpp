...
// SharedPtr<T> WeakPtr<T>::Lock() const | File: ../Container/Ptr.h
static RefCounted* WeakPtr_Lock_void(WeakPtr<RefCounted>* ptr)
{
    SharedPtr<RefCounted> result = ptr->Lock();
    return result.Detach();
}

// WeakPtr<T>::~WeakPtr() noexcept | File: ../Container/Ptr.h
static void WeakPtr_Destructor_WeakPtr_void(WeakPtr<RefCounted>* ptr)
{
...
void ASRegisterGenerated_Members_W(asIScriptEngine* engine)
{
    ...
    // template<class U> void WeakPtr<T>::DynamicCast(const WeakPtr<U>& rhs) | File: ../Container/Ptr.h
    // Not registered because template
    // bool WeakPtr<T>::Expired() const | File: ../Container/Ptr.h
    engine->RegisterObjectMethod("WeakHandle", "bool Expired() const", asMETHODPR(WeakPtr<RefCounted>, Expired, () const, bool), asCALL_THISCALL);
    engine->RegisterObjectMethod("WeakHandle", "bool get_expired() const", asMETHODPR(WeakPtr<RefCounted>, Expired, () const, bool), asCALL_THISCALL);
    // T* WeakPtr<T>::Get() const | File: ../Container/Ptr.h
    ...
    // SharedPtr<T> WeakPtr<T>::Lock() const | File: ../Container/Ptr.h
    engine->RegisterObjectMethod("WeakHandle", "RefCounted@+ Lock() const", asFUNCTION(WeakPtr_Lock_void), asCALL_CDECL_OBJFIRST);
    // bool WeakPtr<T>::NotNull() const | File: ../Container/Ptr.h
    engine->RegisterObjectMethod("WeakHandle", "bool NotNull() const", asMETHODPR(WeakPtr<RefCounted>, NotNull, () const, bool), asCALL_THISCALL);
    // bool WeakPtr<T>::Null() const | File: ../Container/Ptr.h
    engine->RegisterObjectMethod("WeakHandle", "bool Null() const", asMETHODPR(WeakPtr<RefCounted>, Null, () const, bool), asCALL_THISCALL);
    // WeakPtr<T>::operator T*() const | File: ../Container/Ptr.h
    // Not registered because have @nobind mark
    // template<class U> bool WeakPtr<T>::operator!=(const WeakPtr<U>& rhs) const | File: ../Container/Ptr.h
    // Not registered because template
    // T& WeakPtr<T>::operator*() const | File: ../Container/Ptr.h
    // Not registered because have @nobind mark
    // T* WeakPtr<T>::operator->() const | File: ../Container/Ptr.h
    // operator-> can not binded
    // template<class U> bool WeakPtr<T>::operator<(const WeakPtr<U>& rhs) const | File: ../Container/Ptr.h
    // Not registered because template
    // WeakPtr<T>& WeakPtr<T>::operator=(const SharedPtr<T>& rhs) | File: ../Container/Ptr.h
    // Error: type "const SharedPtr<RefCounted>&" can not automatically bind
    // WeakPtr<T>& WeakPtr<T>::operator=(const WeakPtr<T>& rhs) | File: ../Container/Ptr.h
    // Error: type "const WeakPtr<RefCounted>&" can not automatically bind
    // WeakPtr<T>& WeakPtr<T>::operator=(WeakPtr<T>&& rhs) | File: ../Container/Ptr.h
    // Error: type "WeakPtr<RefCounted>&&" can not automatically bind
    // template<class U> WeakPtr<T>& WeakPtr<T>::operator=(const WeakPtr<U>& rhs) | File: ../Container/Ptr.h
    // Not registered because template
    // WeakPtr<T>& WeakPtr<T>::operator=(T* ptr) | File: ../Container/Ptr.h
    // Error: type "WeakPtr<RefCounted>&" can not automatically bind
    // template<class U> bool WeakPtr<T>::operator==(const WeakPtr<U>& rhs) const | File: ../Container/Ptr.h
    // Not registered because template
    // T& WeakPtr<T>::operator[](int index) | File: ../Container/Ptr.h
    // Not registered because have @nobind mark
    // RefCount* WeakPtr<T>::RefCountPtr() const | File: ../Container/Ptr.h
    // Error: type "RefCount*" can not automatically bind
    // int WeakPtr<T>::Refs() const | File: ../Container/Ptr.h
    engine->RegisterObjectMethod("WeakHandle", "int Refs() const", asMETHODPR(WeakPtr<RefCounted>, Refs, () const, int), asCALL_THISCALL);
    engine->RegisterObjectMethod("WeakHandle", "int get_refs() const", asMETHODPR(WeakPtr<RefCounted>, Refs, () const, int), asCALL_THISCALL);
    // void WeakPtr<T>::Reset(T* ptr=nullptr) | File: ../Container/Ptr.h
    engine->RegisterObjectMethod("WeakHandle", "void Reset(RefCounted@+ = null)", asMETHODPR(WeakPtr<RefCounted>, Reset, (RefCounted*), void), asCALL_THISCALL);
    // template<class U> void WeakPtr<T>::StaticCast(const WeakPtr<U>& rhs) | File: ../Container/Ptr.h
    // Not registered because template
    // void WeakPtr<T>::Swap(WeakPtr<T>& rhs) | File: ../Container/Ptr.h
    // Error: type "WeakPtr<RefCounted>&" can not automatically bind
    // unsigned WeakPtr<T>::ToHash() const | File: ../Container/Ptr.h
    engine->RegisterObjectMethod("WeakHandle", "uint ToHash() const", asMETHODPR(WeakPtr<RefCounted>, ToHash, () const, unsigned), asCALL_THISCALL);
    // WeakPtr<T>::WeakPtr(std::nullptr_t) noexcept | File: ../Container/Ptr.h
    // Error: type "std::nullptr_t" can not automatically bind
    // WeakPtr<T>::WeakPtr(const WeakPtr<T>& rhs) noexcept | File: ../Container/Ptr.h
    // Error: type "const WeakPtr<T>&" can not automatically bind
    // WeakPtr<T>::WeakPtr(WeakPtr<T>&& rhs) noexcept | File: ../Container/Ptr.h
    // Error: type "WeakPtr<T>&&" can not automatically bind
    // template<class U> WeakPtr<T>::WeakPtr(const WeakPtr<U>& rhs) noexcept | File: ../Container/Ptr.h
    // Not registered because template
    // WeakPtr<T>::WeakPtr(const SharedPtr<T>& rhs) noexcept | File: ../Container/Ptr.h
    // Error: type "const SharedPtr<T>&" can not automatically bind
    // explicit WeakPtr<T>::WeakPtr(T* ptr) noexcept | File: ../Container/Ptr.h
    // Error: type "T*" can not automatically bind
    // int WeakPtr<T>::WeakRefs() const | File: ../Container/Ptr.h
    engine->RegisterObjectMethod("WeakHandle", "int WeakRefs() const", asMETHODPR(WeakPtr<RefCounted>, WeakRefs, () const, int), asCALL_THISCALL);
    engine->RegisterObjectMethod("WeakHandle", "int get_weakRefs() const", asMETHODPR(WeakPtr<RefCounted>, WeakRefs, () const, int), asCALL_THISCALL);
    // WeakPtr<T>::~WeakPtr() noexcept | File: ../Container/Ptr.h
    engine->RegisterObjectBehaviour("WeakHandle", asBEHAVE_DESTRUCT, "void f()", asFUNCTION(WeakPtr_Destructor_WeakPtr_void), asCALL_CDECL_OBJFIRST);
#ifdef REGISTER_MANUAL_PART_WeakPtr
    REGISTER_MANUAL_PART_WeakPtr(WeakPtr, "WeakPtr")
#endif
