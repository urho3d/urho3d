...
void InitMaterialPreview()
{
    ...
    previewModel.model = cache.GetResource("Model", "Editor/Models/Sphere.mdl");
...
void EditModelPreviewChange(StringHash eventType, VariantMap& eventData)
{
    ...
    {
        case 0:
            previewModel.model = cache.GetResource("Model", "Editor/Models/Box.mdl");
            break;
        case 1:
            previewModel.model = cache.GetResource("Model", "Editor/Models/Sphere.mdl");
            break;
        case 2:
            previewModel.model = cache.GetResource("Model", "Editor/Models/Plane.mdl");
            break;
        case 3:
            previewModel.model = cache.GetResource("Model", "Editor/Models/Cylinder.mdl");
            previewModelNode.scale = Vector3(0.8, 0.8, 0.8);
            break;
        case 4:
            previewModel.model = cache.GetResource("Model", "Editor/Models/Cone.mdl");
            break;
        case 5:
            previewModel.model = cache.GetResource("Model", "Editor/Models/TeaPot.mdl");
            break;
    }
