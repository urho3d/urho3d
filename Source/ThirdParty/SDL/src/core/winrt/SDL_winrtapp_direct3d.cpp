...
{
    // Urho3D
    SDL_SendKeyboardKey(SDL_PRESSED, (Uint32)(SDL_SCANCODE_AC_BACK), SDL_SCANCODE_AC_BACK);
    SDL_SendKeyboardKey(SDL_RELEASED, (Uint32)(SDL_SCANCODE_AC_BACK), SDL_SCANCODE_AC_BACK);
