...
static void WeakPtr_WeakPtr_void(WeakPtr<RefCounted>* ptr)
{
...
void ASRegisterGenerated_Members_HighPriority(asIScriptEngine* engine)
{
    ...
    // WeakPtr<T>::WeakPtr() noexcept | File: ../Container/Ptr.h
    engine->RegisterObjectBehaviour("WeakHandle", asBEHAVE_CONSTRUCT, "void f()", asFUNCTION(WeakPtr_WeakPtr_void), asCALL_CDECL_OBJFIRST);
    // XPathQuery::XPathQuery() | File: ../Resource/XMLElement.h
