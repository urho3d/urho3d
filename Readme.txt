...
Urho3D classes have also been sparsely documented using Doxygen notation.
Use the Doxyfile in the root directory to build the documentation, which will
be created into the "Docs" subdirectory. Doxygen is available at:
